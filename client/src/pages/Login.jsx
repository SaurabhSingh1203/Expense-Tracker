            ...
            <div className="hidden lg:flex lg:w-1/2 relative bg-neutral-900 overflow-hidden items-center justify-center border-r border-neutral-800">
                ...
                <div className="relative z-10 text-center px-16">
                    ...
                    <p className="text-lg text-neutral-400 max-w-md mx-auto leading-relaxed">
                        Discover, manage, and experience unforgettable moments. Your gateway to extraordinary events starts here.
                    </p>
                </div>
            </div>
                ...
                <div className="w-full max-w-md space-y-8">
                    <div>
                        ...
                        <p className="mt-2 text-sm text-neutral-400">
                            Securely access your OurEvents dashboard
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="mt-8 space-y-6">
                        {!showOTP ? (
                            ...
                            <div>
                                <label htmlFor="otp" className="block text-sm font-medium text-center text-neutral-300 mb-4">
                                ...
                                <p className="mt-4 text-xs text-center text-neutral-500">
                                    Check your inbox. We've sent a code to your email.
                                </p>
                            </div>
                        )}
                        ...
                        <button
                            ...
                            className={`flex w-full justify-center rounded-md px-3 py-4 text-sm font-semibold leading-6 text-white shadow-sm transition-all focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 ${
